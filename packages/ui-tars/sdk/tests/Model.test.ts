...
describe('UITarsModel', () => {
  ...
  describe('Google Gemini 3.0+ API', () => {
    it('should configure and invoke Google Gemini 3.7 Flash correctly', async () => {
      const model = new UITarsModel({
        ...
        choices: [
          {
            message: {
              content:
                'Thought: Clicking on search bar\nAction: click(start_box="<point>500 200</point>")',
            },
          },
        ],
              ...
              content: [
                {
                  type: 'image_url',
                  image_url: {
                    url: 'data:image/png;base64,base64geminiimage',
                  },
                },
              ],
            }),
      ...
      expect(res.prediction).toContain('click(start_box="<point>500 200</point>")');
    });
  });
});
